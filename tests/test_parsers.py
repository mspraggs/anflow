...
def study_base_parser(settings, request):
    component_file = os.path.join(settings.PROJECT_ROOT,
    ...
    with open(component_file, 'w') as f:
        f.write('from anflow.core.parsers.base import BaseParser\n')
        f.write('def get_parser():\n')
        f.write('    return BaseParser()\n')
